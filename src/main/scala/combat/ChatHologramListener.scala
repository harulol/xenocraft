...
/**
 * Listener dedicated to turn chat messages into
 * floating holograms above their head.
 */
object ChatHologramListener extends Listener:
   ...
   * for other reasons by other plugins.
   *
   * This method should be called if you cancel the AsyncPlayerChatEvent to send
   * your own message in your system, but still would like the hologram to be
   * displayed.
   *
