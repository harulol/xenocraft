...
enum ClassType(
  ...
  /** Retrieves the name of the hero who wields this class.
    ...
    *   the wielder's name
    */
  def wielderName(locale: Locale): String = ClassesGUI.getModule.translate(locale, s"$keyName-wielder")
  ...
  /** Retrieves the proper title of the hero who wields this class.
    ...
    *   the wielder's title
    */
  def wielderTitle(locale: Locale): String = ClassesGUI.getModule.translate(locale, s"$keyName-title")
  ...
  /** Retrieves the properly displayed name of the class type.
    ...
    *   the name
    */
  def displayName(locale: Locale): String = ClassesGUI.getModule.translate(locale, s"$keyName-name")
  ...
  /** Retrieves the full name for the Soulhacker class with the soul involved.
    *
    * @param locale
    *   the locale
    * @return
    *   the full name
    */
  def soulhackerName(locale: Locale): String =
    if isSoulhacker then ClassesGUI.getModule.translate(locale, "soulhacker-soul", Pair.of("soul", soulName(locale)))
  ...
  /** Retrieves the soul name of the Soulhacker class.
    ...
    *   the soul name
    */
  def soulName(locale: Locale): String =
    if isSoulhacker then
  ...
  /** Checks if this class is one of the soul hacker classes.
    *
    * @return
    *   whether this is a soulhacker class
    */
